  ...
  "side-el-nas": [
    {
      ...
      servers: [
        ...
        {
          name: "Server 2",
          iframe: "https://uqload.ws/embed-4p5xj067ympj.html",
        },
        {
          name: "Server 3",
          iframe:
    ...
    },
    {
      ...
      servers: [
        {
          name: "Server 1",
          iframe: "https://uqload.ws/embed-a3uephe9z0jh.html",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      servers: [
        {
          name: "Server 1",
          iframe: "https://uqload.ws/embed-3wp5kk7uia61.html",
        },
        {
          name: "Server 2",
          iframe: "https://w.vidoba.site/embed-l3d64mtzk0d0.html",
  ...
  el_serp: [
    {
      episodeNumber: 1,
      servers: [
        { name: "Server 1", iframe: "https://playerwish.com/e/5p5aewu481my" },
        {
          name: "Server 2",
          iframe: "https://vidhideplus.com/embed/ecmhuhrpjrni",
        },
      ],
    },
  ],
...
export default function WatchEpisodeClient({
  ...
  series: string;
  episode?: string; // لو فيلم، ممكن مفيش حلقة
}) {
  const episodes = episodesData[series] || [];

  // لو مسلسل
  const isSeries = episodes.length > 1;

  // الحلقة الحالية: لو مسلسل استخدم الرقم من URL، لو فيلم استخدم الحلقة الوحيدة
  const episodeIndex = isSeries ? +(episode || "1") - 1 : 0;
  const currentEpisode = episodes[episodeIndex];
